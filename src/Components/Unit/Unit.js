...
export default function Unit(props) {
    ...
    return (
        <div type={`${props.animal}`} className={`unit ${props.animal} ${props.selected} ${props.fighting} ${props.dying}`} onClick={(e)=>props.handleClick(e, props.position, props.id, props.type)}>
